...
def build_prompt(context, question):
    ...
    prompt_template = prompt_template_config(config.RAG_PROMPT_TEMPLATE_PATH, "rag_generation")  # Get from local yaml file 
    # prompt_template = prompt_template_registry("job-posting-rag-tracing")   # Get from Langsmith
